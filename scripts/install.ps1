...
$ExePath = Join-Path $ScriptDir "console-agent.exe"
if (-not (Test-Path -LiteralPath $ExePath)) {
    throw "Missing console-agent.exe next to install.ps1."
}
...
Write-Host "Open http://127.0.0.1:$Port/api/status to test this PC."
